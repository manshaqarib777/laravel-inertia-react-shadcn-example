...
const TableToolbar: FC<TableToolbarProps> = ({ placeholder, params, setParams, setTimeDebounce, search }) => {
    const [limit, setLimit] = useState((params && params.limit || 10).toString());
